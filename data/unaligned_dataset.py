...
class UnalignedDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.transformA = []
        self.transformA.append(transforms.Resize(
            (opt.fineSize*2, opt.fineSize), Image.BICUBIC))
    ...
    def __getitem__(self, index):
        ...
        # .convert('RGB') # A image is a no_input*3 collection of images
        ...
        # print("shape before unsqueeze a1", A1.shape) -> torch.Size([3, 256, 256])
        A1 = A1.unsqueeze(0).numpy()
        A2 = A2.unsqueeze(0).numpy()
        # print("shape after unsqueeze a1", A1.shape) -> (1, 3, 256, 256)
