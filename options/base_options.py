...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument(
            '--dataroot', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')  # 1
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            '--input_nc2', type=int, default=3, help='# of input2 image channels')
        self.parser.add_argument(
        ...
        self.parser.add_argument('--name', type=str, default='experiment_name',
                                 help='name of the experiment. It decides where to store samples and models')  # 2
        ...
        self.parser.add_argument(
            '--no_input', type=int, default=1, help='number of modalities')
        self.parser.add_argument('--model', type=str, default='cycle_gan',
                                 help='chooses which model to use. cycle_gan, pix2pix, test')  # 3
        self.parser.add_argument(
